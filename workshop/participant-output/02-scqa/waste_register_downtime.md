# DOWNTIME Waste Register — Stage 02 (Frame), updated from Stage 01

**Frame-stage update:** carried forward unchanged from
`docs/product/discovery/waste_register_downtime.md`. The SCQA narrative (Stage 02) confirms
all Stage 01 findings still hold; its one refinement is a **priority correction**, not a new
row: the **Transportation** row is now understood as directly addressed by the Answer's
