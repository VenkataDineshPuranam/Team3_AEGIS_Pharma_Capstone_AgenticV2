...
|---|---|---|---|---|
| 01 Discovery | [dmaic_lens.md](../../../docs/product/discovery/dmaic_lens.md) | **Full** | All five | V1's single-shot architecture is the root cause of the gap V2 exists to close; token/cost baseline **Unknown** |
